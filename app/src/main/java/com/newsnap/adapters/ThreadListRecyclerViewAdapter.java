 ...
 */
public class ThreadListRecyclerViewAdapter
        extends RecyclerView.Adapter<ThreadListRecyclerViewAdapter.ViewHolder> {
    ...
    public ThreadListRecyclerViewAdapter(Thread[] mDataset) {

        this.mDataset = mDataset;
    }

    @Override
    public ThreadListRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {

        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.recyclerview_item, viewGroup, false);

        ViewHolder vh = new ThreadListRecyclerViewAdapter.ViewHolder(v);
        return vh;
    }
